...
/**
 * 
 *<p>Title	: DPattern01Ch01_05_Test06.java</p>
 * @Description :
 * @author 	: admin
 * @date	: 2018年2月6日
 */
public class DPattern01Ch01_05_Test06 {
	//实现深拷贝实例(clone时新建ArrayList<String>)：
	//运行结果：
//	1.原型
...
//	============================
	public static void main(String[] args) throws CloneNotSupportedException {
		DPattern01Ch01_05_Shallow06 shallow = new DPattern01Ch01_05_Shallow06();
		...
		DPattern01Ch01_05_Shallow06 shallow2 = shallow.clone();
...
class DPattern01Ch01_05_Shallow06 implements Cloneable{
	ArrayList<String> shallowList = new ArrayList<String>();
	
	public DPattern01Ch01_05_Shallow06 clone() throws CloneNotSupportedException{
		//只是clone() 属于浅拷贝
		DPattern01Ch01_05_Shallow06 shallow = (DPattern01Ch01_05_Shallow06) super.clone();
		//手动操作属于深拷贝
	    if(shallowList != null){
	    	for (String s : shallowList) {
	    		ArrayList<String> _shallowList = new ArrayList<String>();
	    		_shallowList.add(s);
	    		shallow.setShallowList(_shallowList);
			}
	    }
		return shallow;
	}
